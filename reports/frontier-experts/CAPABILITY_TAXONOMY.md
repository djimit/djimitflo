...
| `automated_ai_research` | Automated AI research | — | ai for ai research, research automation |
| `recursive_self_improvement` | Recursive self-improvement | `automated_ai_research` | rsi, self-improving ai |
...
| `model_control` | Model control | — | ai control, control protocols |
...
| `cyber_capabilities` | Cyber capabilities | `ai_security` | offensive cyber, cyber evals |
