...
✓ [X] T001 [P] Add catalog API methods to `packages/dashboard/src/lib/api.ts`:
...
✓ [X] T002 Create `packages/dashboard/src/hooks/useCatalog.ts` data hook:
...
✓ [X] T003 [P] [US1] Write test for AgentCatalogPage rendering with agents in
...
✓ [X] T004 [P] [US1] Write test for empty state in
...
✓ [X] T005 [P] [US1] Create `packages/dashboard/src/components/AgentCatalogTable.tsx`:
...
✓ [X] T006 [US1] Create `packages/dashboard/src/pages/AgentCatalogPage.tsx`:
...
✓ [X] T007 [US1] Add route to `packages/dashboard/src/App.tsx`:
...
✓ [X] T008 [P] [US2] Write tests for division filter and search in
...
✓ [X] T009 [US2] Add division filter dropdown and search input (debounced 300ms)
...
✓ [X] T010 [P] [US3] Write tests for activate/deactivate in
...
✓ [X] T011 [US3] Add activate/deactivate buttons to `AgentCatalogTable.tsx`:
...
✓ [X] T012 [P] Run full test suite: `npm test` and `npm run type-check` and `npm run lint`
  - **Validation**: all pass, no new warnings
  - **Rollback**: n/a (read-only validation)
  - **Execution Surface**: host:macbook

✓ [X] T013 Run quickstart validation: navigate to /catalog, verify all 3 user
