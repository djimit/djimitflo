...
export interface RankedMemory {
  record: MemoryRecord; reward: number; rank: number;
}
...
export class RLHFMemoryRanker {
  ...
  recordReward(memoryId: string, loopRunId: string, outcome: 'success' | 'failure' | 'partial', utility: number): void {
