...
export const FRONTIER_SKILLS: FrontierSkill[] = [
  { slug: 'software-engineering-analysis', title: 'AI software engineering analysis', capabilities: ['ai_software_engineering', 'code_generation', 'program_repair', 'software_testing', 'coding_agents'], purpose: 'Assess claims about models and agents that write, repair and test code: what was measured, on which repositories, against which oracle.', evidence: 'papers and repositories with executable benchmarks (tests as oracle), contamination checks, pass@k with sample sizes, ablations of tools and context', falsification: 'Name the repository, language or oracle change under which the reported gain was not measured, and whether a held-out or post-cutoff set was used.', shortcuts: 'benchmark scores without contamination checks; single-repository anecdotes; passing tests that do not exercise the change' },
