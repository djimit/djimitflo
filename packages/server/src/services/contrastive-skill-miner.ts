...
export class ContrastiveSkillMiner {
  ...
  getClusters(): any[] { return this.db.prepare("SELECT * FROM pattern_clusters ORDER BY member_count DESC").all(); }
  deduplicate(): { merged: number; removed: number } { return { merged: 0, removed: 0 }; }
