...
export function seedMCPServers(db: Database) {
  ...
  const servers = [
    ...
    { name: 'qdrant', url: 'http://192.168.1.28:6333', description: 'Semantic search — 18,888 chunks, collections, vector search' },
    ...
    { name: 'uams-read', url: 'http://192.168.1.28:8000/memory', description: 'Agent memory search — read-only, 57 entries' },
